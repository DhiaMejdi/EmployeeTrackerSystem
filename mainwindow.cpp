...
#include <QRegularExpression>
        ...
        , ui(new Ui::MainWindow)
    {
        ...
        QPalette palette;
        QPixmap pixmap("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/back55.jpg");
        ...
        ui->logo->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/logo9.png"));
        ui->logo->setIconSize(QSize(161, 91));
        ui->logo->setStyleSheet(commonButtonStyle);

        ui->btnemploye->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/employe.png"));
        ui->btnemploye->setIconSize(QSize(50, 50));
        ui->btnemploye->setStyleSheet(commonButtonStyle);

        ui->btnpatient->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/patient.png"));
        ui->btnpatient->setIconSize(QSize(50, 50));
        ui->btnpatient->setStyleSheet(commonButtonStyle);

        ui->btnvaccins->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/vaccins.png"));
        ui->btnvaccins->setIconSize(QSize(50, 50));
        ui->btnvaccins->setStyleSheet(commonButtonStyle);

        ui->btnequipement->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/equipement.png"));
        ui->btnequipement->setIconSize(QSize(50, 50));
        ui->btnequipement->setStyleSheet(commonButtonStyle);

        ui->btnformation->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/formation.png"));
        ui->btnformation->setIconSize(QSize(50, 50));
        ui->btnformation->setStyleSheet(commonButtonStyle);

        ui->btnrecherche->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/recherche.png"));
        ui->btnrecherche->setIconSize(QSize(50, 50));
        ui->logout->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/logout1.png"));
        ...
        ui->rech->setIcon(QIcon("C:/Users/hp/Desktop/2A17/qt/S10/Qt (5)/Qt/Qt/interfce/reche.png"));
       ...
       ui->combo_stat->addItem("Genre");
        ...
        connect(serialCom, &SerialCommunication::uidReceived, this, &MainWindow::checkUidInDatabase);
        connect(serialCom, &SerialCommunication::uidAuthorized, this, &MainWindow::handleUidFromArduino);
        connect(ui->addUidToEmployee, &QPushButton::clicked, this, &MainWindow::addUidToEmployee);
    ...
    void MainWindow::checkUidInDatabase(const QString &uid)
    {
    ...
    void MainWindow::handleUidFromArduino(const QString &uid) {
    ...
    void MainWindow::handleUidAuthorized(const QString &uid) {
    ...
    void MainWindow::addUidToEmployee()
    {
